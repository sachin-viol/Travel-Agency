...
const destinations = [
  ...
  {
    name: "Vietnam",
    image: "https://images.pexels.com/photos/58597/pexels-photo-58597.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    price: "Rs. 57,999/-",
    slug: "vietnam"
  },
  {
  ...
  {
    name: "Bhutan",
    image: "https://images.pexels.com/photos/910368/pexels-photo-910368.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    price: "Rs. 39,999/-",
    slug: "bhutan"
  },
  {
  ...
  return (
    <section className="relative py-16 bg-white">
      ...
      <div className="container-custom relative z-10">
        ...
        <Link to="/trips?category=international" className="btn-primary mb-8 inline-flex items-center">

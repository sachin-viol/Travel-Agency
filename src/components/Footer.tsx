        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/trips" className="text-white/80 hover:text-white transition-colors">Our Trips</Link>
              </li>
              <li>
                <Link to="/blog" className="text-white/80 hover:text-white transition-colors">Travel Blog</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/destinations/switzerland" className="text-white/80 hover:text-white transition-colors">Switzerland</Link>
              </li>
              <li>
                <Link to="/destinations/japan" className="text-white/80 hover:text-white transition-colors">Japan</Link>
              </li>
              <li>
                <Link to="/destinations/costa-rica" className="text-white/80 hover:text-white transition-colors">Costa Rica</Link>
              </li>
              <li>
                <Link to="/destinations/peru" className="text-white/80 hover:text-white transition-colors">Peru</Link>
              </li>
              <li>
                <Link to="/destinations/new-zealand" className="text-white/80 hover:text-white transition-colors">New Zealand</Link>
              </li>
            </ul>
          </div>

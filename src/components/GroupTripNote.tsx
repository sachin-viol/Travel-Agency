  ...
  return (
    <div className="py-12 bg-travel-sand-light/30">
      <div className="container-custom">
        <div className="flex flex-col md:flex-row items-center justify-between p-8 rounded-xl bg-travel-cloud-white shadow-md border border-gray-100">
          ...
          <Link to="/trips" className="btn-primary travel-cloud-whitespace-nowrap">Explore Group Trips</Link>
        </div>
      </div>
    </div>
  );
